...
<jsp:useBean id="sampleDemoClassProxyid" scope="session" class="com.DemoClassProxy" />
<%
...
case 10:
        gotMethod = true;
        com.DemoClass getDemoClass10mtemp = sampleDemoClassProxyid.getDemoClass();
...
case 13:
        ...
        com.DemoModel getUser13mtemp = sampleDemoClassProxyid.getUser(name_1idTemp);
...
<TR>
<TD WIDTH="5%"></TD>
<TD COLSPAN="2" ALIGN="LEFT">idade:</TD>
<TD>
<%
if(getUser13mtemp != null){
%>
<%=getUser13mtemp.getIdade()
%><%}%>
</TD>
</TABLE>
<%
